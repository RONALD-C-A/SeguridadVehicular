...
<body>
    ...
    <div class="form-container" id="registerContainer">
        <div class="form-box" style="--li: 1;">
            <h2 class="welcome-text">¡REGÍSTRATE!</h2>
            ...
            <form id="registerForm" method="POST" action="{{ route('register') }}" novalidate>
                ...
                <p class="mt-3 text-center"><a href="{{ route('login') }}" class="link-custom">¿Ya tienes una cuenta? Inicia Sesión</a></p>
            </form>
        </div>
    </div>
